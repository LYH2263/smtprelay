...
// Bytes returns an independent copy of b. The returned slice shares no
// backing array with b, so callers may mutate either without affecting the
// other. Returns nil for nil.
